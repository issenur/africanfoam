                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Shop Name</label>
                     <input type="text"  class="form-control" id="sales_form_shop_name" name="shop_name" placeholder="Shop Name">
                  </div>
                  <div class="form-group">
...
<script>
  $(document).ready(function() {
      $("form").submit(function(event){
        ...
        var shop_name = $("#sales_form_shop_name").val();
        ...
        $(".sales_form_message").load("CustomerEndUserRegistrationController.php", {
            username: username,
            password: password,
            shop_name: shop_name,
            first: first,
