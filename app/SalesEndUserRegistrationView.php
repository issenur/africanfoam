          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <form id="sales_add_form"">
                <div class="card-body">
                  <div class="form-group action="SalesEndUserRegistrationController.php" id="sales_add_form" method="post"">
...
<script>
  $(document).ready(function() {
      $("form").submit(function(event){
        ...
        $(".sales_form_message").load("SalesEndUserRegistrationController.php", {
            username: username,
            password: password,
            first: first,
            last: last,
